    ...
    */
    _mixerDeviceAdded(id) {
        ...
        if (mixerUiDevice.get_origin()) {
            this._outputAudioDeviceMap.set(id, mixerUiDevice.get_description() + " - " + mixerUiDevice.get_origin());
        } else {
            this._outputAudioDeviceMap.set(id, mixerUiDevice.get_description());
        }
