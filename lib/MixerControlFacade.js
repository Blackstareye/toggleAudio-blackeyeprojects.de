...
export default class MixerControlFacade {
    ...
    _sync_default_output() {
        ...
        this._settingProvider.settingInstance.connect("changed::headphone-on", (settingsInstance, k) => {
            this._applyChanges(settingsInstance,k);
        });
    }

    _applyChanges(settingsInstance,key) {
        let v = settingsInstance.get_boolean(key);
            ...
            Debugging-Log:
                Instance ${this._sessionName}
                    ...
                    Gnome-Settings:
                        ...
                        output-schema-list: ${this._printBeautyArray(this.settingProvider.getOutputDevicesSchemaList())}
        `);
    }
    ...
    _setDefaultAudioOutput(runtime_id) {
        // this._waitForMixerToBeReady(this._mixerControl).then( () => {
            ...
            if (device) {
                ...
                console.error(`${this._printBeautyArray(this.settingProvider.getOutputDevicesSchemaList())} and id: ${runtime_id}`);
            }
        // }).catch(e => console.error(`Cant connect to mixer`, e));
    }
    ...
    */
    _mixerDeviceAdded(id) {
        ...
        // get old list 
        let currentOutputDeviceSchemaList = this.settingProvider.getOutputDevicesSchemaList();
        // add newDevice
