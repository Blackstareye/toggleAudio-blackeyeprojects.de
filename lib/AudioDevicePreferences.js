...
export default class AudioDevicePreferences {
    ...
    _buildListModel() {
        ...
        console.log(`headphone: ${this._indexHeadphoneModel}, speaker: ${this._indexSpeakerModel}, remote headphone: ${this._indexRemoteHeadphoneModel}`);
    }
    ...
    _createToggleHotKeys(page) {
        ...
        const activateToggleRemoteHeadphoneHotkey = new Adw.SwitchRow({
        ...
        toggleHotKeysGroup.add(activateToggleRemoteHeadphoneHotkey);
        ...
        this._settingProvider.bindEnableToggleRemoteHeadphoneHotKey(activateToggleRemoteHeadphoneHotkey); //bindEnableToggleRemoteHeadphoneHotKey
    }
    ...
    _createOutputDeviceGroup(page) {
        ...
        this._settingProvider.onRemoteHeadphoneSettingChange( (_,k) => {
            ...
            this._remoteHeadphoneModel.visible = provider.getEnabledToggleRemoteHeadphone();
        });
        outputDeviceGroup.add(this._remoteHeadphoneModel);

        this._remoteHeadphoneModel.connect(`notify::selected-item`, () => {
            this._settingProvider.setRemoteHeadphone(this._packData(this._remoteHeadphoneModel.selected_item)); //TODO setRemoteHeadphone
        });
    }
