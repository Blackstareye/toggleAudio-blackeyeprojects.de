...
export default class AudioDevicePreferences {
    ...
    _createStylingPage(page) {
        ...
        const customization = new Adw.PreferencesGroup({
            ...
            description: _(`If you want customized icons, you can follow this <a href='${Constants.WIKI_LINKS["Customization"]}'>wiki</a>`),
        });
